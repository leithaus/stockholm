...
import _root_.com.biosimilarity.reflection.model._
...
class Boot {
  def boot {
    ...
    LiftRules.addToPackages("com.biosimilarity.reflection")
...
//       :: Menu(Loc("Examples.1", "examples", "Examples", If(User.loggedIn_? _, "x")))       
       :: User.sitemap)
